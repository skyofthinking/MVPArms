...
import io.github.skyofthinking.busline.base.api.Api;
...
import io.github.skyofthinking.busline.base.api.service.CommonService;
import io.github.skyofthinking.busline.base.api.service.UserService;
...
public class GlobalConfiguration implements ConfigModule {
    ...
    public void registerComponents(Context context, IRepositoryManager repositoryManager) {
        repositoryManager.injectRetrofitService(CommonService.class, UserService.class, BusLineService.class);
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                ...
                if (activity.findViewById(R.id.base_toolbar) != null) {
                    if (activity instanceof AppCompatActivity) {
                        ((AppCompatActivity) activity).setSupportActionBar((Toolbar) activity.findViewById(R.id.base_toolbar));
                        ((AppCompatActivity) activity).getSupportActionBar().setDisplayShowTitleEnabled(false);
                    } else {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            activity.setActionBar((android.widget.Toolbar) activity.findViewById(R.id.base_toolbar));
                            activity.getActionBar().setDisplayShowTitleEnabled(false);
                        }
                    }
                }
                if (activity.findViewById(R.id.toolbar_title_text) != null) {
                    ((TextView) activity.findViewById(R.id.toolbar_title_text)).setText(activity.getTitle());
                }
                if (activity.findViewById(R.id.toolbar_left) != null) {
                    activity.findViewById(R.id.toolbar_left).setOnClickListener(v -> {
